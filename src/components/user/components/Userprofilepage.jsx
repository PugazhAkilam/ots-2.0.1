...
function UserProfile() {
  ...
  const handleLogout = () => {
    ...
    navigate('/user');  // Redirect to the homepage or login page
  };
  ...
  return (
    <> 
      ...
      <Grid item xs={6} sm={6} md={3} lg={3}>
          <Card onClick={() => handleCardClick('/user')} style={{ cursor: 'pointer' , backgroundColor:isDarkMode?"rgb(36, 36, 36)":"rgba(220, 239, 255, 1)"}}>
        ...
        <Grid item xs={6} sm={6}md={3} lg={3}>
          <Card onClick={() => handleCardClick('/useraddress')}  style={{ cursor: 'pointer' , backgroundColor:isDarkMode?"rgb(36, 36, 36)":"rgba(220, 239, 255, 1)"}}>
            <CardContent style={{ textAlign: 'center' }}>
        ...
        <Grid item xs={6} sm={6}md={3} lg={3}>
          <Card onClick={() => handleCardClick('/history')}  style={{ cursor: 'pointer' , backgroundColor:isDarkMode?"rgb(36, 36, 36)":"rgba(220, 239, 255, 1)"}}>
            <CardContent style={{ textAlign: 'center' }}>
        ...
        <Grid item xs={6} sm={6}md={3} lg={3}>
          <Card onClick={() => handleCardClick('/wishlist')}  style={{ cursor: 'pointer' , backgroundColor:isDarkMode?"rgb(36, 36, 36)":"rgba(220, 239, 255, 1)"}}>
            <CardContent style={{ textAlign: 'center' }}>
        ...
        <Grid item xs={6} sm={6}md={3} lg={3}>
          <Card onClick={() => handleCardClick('/cart-category')}  style={{ cursor: 'pointer' , backgroundColor:isDarkMode?"rgb(36, 36, 36)":"rgba(220, 239, 255, 1)"}}>
            <CardContent style={{ textAlign: 'center' }}>
